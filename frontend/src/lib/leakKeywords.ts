...
const keywordRules: KeywordRule[] = [
  ...
  { label: 'נסיון הבודק', hints: ['10 שנות ניסיון', 'ותק'], patterns: [/נסיון הבודק|ניסיון הבודק/i, /ניסיו(?:ן|ן)|ותק|שנים בתחום|שנות ניסיון/i] },
...
export function detectLeakKeywords(prompt: string): KeywordDetection {
